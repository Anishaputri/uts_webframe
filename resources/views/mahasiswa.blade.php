...
@section('content')
    <section class="jumbotron text-center">
        <img src="{{asset('gatau/img/bgst.jpg')}}" alt="Cia" width="200" class="rounded-circle img-thumbnail">
        <h1 class="mt-1 display-4">Anisha putri</h1>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center fs-5 text-center">
                <div class="col-lg-4 col-xs-12">
                    <p>Saya Anisha putri anak dari</p>
                </div>
